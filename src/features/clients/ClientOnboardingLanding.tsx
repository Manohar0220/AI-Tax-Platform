...
export function ClientOnboardingLanding() {
    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center">
      <div className="w-full max-w-md">
        <h1 className="text-2xl font-semibold text-text-primary mb-2">
          {inProgress ? 'Welcome back.' : "Let's start your personal tax return."}
        </h1>
        <p className="text-sm text-text-secondary mb-6">
          {inProgress
            ? 'You have a questionnaire in progress. Pick up where you left off.'
            : "Answer a few simple questions and we'll create a document checklist for you."}
        </p>
        ...
        <Button onClick={() => navigate('/my-return/onboarding')}>
          {inProgress ? 'Continue setup' : 'Start my return'}
        </Button>
      </div>
    </div>
  )
